...
calib_path = '/media/ljh/Kobe24/KITTI_Semantic/training/calib_cam_to_cam'
disp_path = '/media/ljh/Kobe24/KITTI_Semantic/training/LJH_2015/disp'
depth_path = os.path.join(dataset_base, "training", "vitas_depth_0")  # 存放深度图的目录
